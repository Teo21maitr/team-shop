...
- [X] 10.9. Test rename with multiple active users (P13 — R22)
- [X] 10.10. Test edge case: user has claimed items (orange state) (P13 — R22)

## Phase 11 — Easter Egg (Christmas Cat Animation)

- [x] 11.1. Create `ChristmasAnimation` component (P14 — R23)
- [x] 11.2. Implement falling snowflakes animation (P14 — R23)
- [x] 11.3. Create animated cat popping from gift box (P14 — R23)
- [x] 11.4. Add text overlay "Ton bibou t'offre un petit chat pour Noël" (P14 — R23)
- [x] 11.5. Implement client-side trigger logic: list contains "Un gentil bibou" AND item.name === "Chat" (P14 — R23)
- [x] 11.6. Ensure animation is visible only to user who added the item (client-side only) (P14 — R23)
- [x] 11.7. Ensure animation does not block UI interactions (P14 — R23)
- [x] 11.8. Set animation duration and fade-out (~5-10 seconds) (P14 — R23)
- [ ] 11.9. Test case-sensitivity: "Chat" and "Un gentil bibou" only (exact matches) (P14 — R23)
- [ ] 11.10. Test item-based trigger: only lists containing "Un gentil bibou" (P14 — R23)
